...
if args.checkpoint != '': model.load_weights(args.checkpoint, by_name = True, skip_mismatch = True)
...
#basemodel.save(runPath + '/model', save_format='tf')
model.save_weights(runPath + '/final_model_weights/model_weights', save_format='tf')
